...
<table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
    ...
    <tbody>
        <?php
            $sql = "SELECT t.*,
            (SELECT firstname FROM student WHERE id=t.fingerprint) AS firstname,
            (SELECT lastname FROM student WHERE id=t.fingerprint) AS lastname,
            (SELECT grade FROM student WHERE id=t.fingerprint) AS grade,
            (SELECT strand FROM student WHERE id=t.fingerprint) AS strand,
            (SELECT section FROM student WHERE id=t.fingerprint) AS section
            FROM $table t  WHERE t.table_name='student'";
