...
<script>
    function form_data(id,title,tagifys){
        ...
        document.getElementById('post_content').innerHTML=document.getElementById(description).value;
        tagifiess();
        ...
        <div class="modal-content">
           ...
           <form method="POST" name="edit_form">
                <div class="modal-body">
                    ...
                    <div class="mb-10">
                        <label class="form-label">Skill Requirements </label>
                        <input class="form-control" name="tagify" disabled="" value="" id="kt_tagify_3"/>
                    </div>
                </div>
