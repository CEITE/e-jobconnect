				...
				<div class="text-wrapper align-left" data-form-type="formoid">
					<form  action="find_a_job.php" >
						<div class="dragArea row">
							...
							<div class="col-auto mbr-section-btn"><button type="submit" class="w-100 btn btn-secondary display-7"><span class="mbri-search mbr-iconfont mbr-iconfont-btn"></span>Search</button></div>
						</div>
					</form>
				</div>
			</div>
