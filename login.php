						...
						<div class="w-lg-500px p-10">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="index.html" action="#">
								...
								<div class="separator separator-content my-14">
									<span class="w-125px text-gray-500 fw-semibold fs-7">Put correctly</span>
								</div>
								<!--end::Separator-->
								<?php
									if(isset($_GET['error'])){
								...
								<a href="authentication/layouts/corporate/sign-up.html" class="link-danger">Sign up</a></div>
								<!--end::Sign up-->
							</form>
							<!--end::Form-->
						</div>
